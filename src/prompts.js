...
function buildControllerPrompt(manifest, request) {
  ...
  return [
    ...
    '- After Claude finishes, inspect the repo, git diff, files, or tests as needed before deciding whether to send Claude another message or stop.',
    ...
    '- Explicitly mention what you checked in controller_messages when reviewing Claude work, for example checking git diff, opening a file, or rerunning tests.',
    '',
    'Examples:',
